...
Car_SRN = {
    ...
    int(3e4): {},
    # # "dataset_path": "/home/ec2-user/graf-main/data/*.png",  # '/home/marcorm/S-GAN/data/cats_bigger_than_128x128/*.jpg',
    # # "dataset_poses_path": "/home/ec2-user/graf-main/data/carla/carla_poses/*.npy",
    # "dataset_path": "carla/*.png",  # '/home/marcorm/S-GAN/data/cats_bigger_than_128x128/*.jpg',
    # "dataset_poses_path": "carla_poses/*.npy",
    "dataset_path": "/home/shreya/3d-learning-project/srn_cars/cars",
    # "dataset_poses_path": "/home/shreya/pi-GAN/carla_poses/*.npy",
    "only_upper_hem": False,
    "fov": 30,
    "ray_start": 0.7,
    "ray_end": 1.3,
    "fade_steps": 10000,
...
CARLA = {
    ...
    # "dataset_path": "carla/*.png",  # '/home/marcorm/S-GAN/data/cats_bigger_than_128x128/*.jpg',
    # "dataset_poses_path": "carla_poses/*.npy",
    "dataset_path": "/home/shreya/pi-GAN/carla_dataset/*.png",
    "dataset_poses_path": "/home/shreya/pi-GAN/carla_poses/*.npy",
    "fov": 30,
    "ray_start": 0.7,
    "ray_end": 1.3,

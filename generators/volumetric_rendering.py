...
def transform_sampled_points(
    ...
    if camera_extrinsics is None:
        ...
        camera_extrinsics[:, :3, 3] = normalized_camera_pos
        # cam2world_matrix = torch.inverse(camera_extrinsics)
        cam2world_matrix = camera_extrinsics
        # TODO: is this fine? We should not use it if we have gt camera extrinsics
    ...
    # print("points_homogeneous = ",  points_homogeneous.reshape(n, -1, 4).permute(0, 2, 1).shape)
    transformed_points = (
        torch.bmm(
